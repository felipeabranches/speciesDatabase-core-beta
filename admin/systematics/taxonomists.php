...
// Titles
$file_name = 'taxonomists';
$page_name = 'Taxonomists';
...
$db = getDbInstance();
$cols = array(
    'tt.id id', 'tt.name name', 'tt.published published'
);
...
if ($search_string)
{
    $db->where('tt.name', '%'.$search_string.'%', 'like');
}
    ...
    <div class="toolbar sticky-top row my-2 p-2">
        <div class="col-12">
            ...
            <div class="float-right">
                <a href="taxonomist.php?task=new&id=0" class="btn btn-primary btn-sm" role="button"><i class="fas fa-plus"></i>New</a>
            </div>
        </div>
    </div>
    <!-- Main -->
            ...
            <div class="my-3 p-3 bg-white rounded box-shadow">
                ...
                <form class="form-inline mb-3" action="">
                    ...
                    <select name="order_by" class="form-control mr-2">
                        <?php
                        foreach ($taxonomists->getOrderValues() as $opt_value => $opt_name):
                ...
                <table class="table table-striped table-hover table-sm">
                    ...
                    <thead>
                        <tr width="100%">
                            <th width="5%"><a href="<?php echo $file_name; ?>.php?order_by=tt.id">ID</a></th>
                            <th width="90%"><a href="<?php echo $file_name; ?>.php?order_by=tt.name">Name</a></th>
                            <th width="5%" colspan="2"><a href="<?php echo $file_name; ?>.php?order_by=tt.published">State</a></th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="taxonomist.php?task=edit&id=<?php echo $row['id']; ?>"><?php echo htmlspecialchars($row['name']); ?></a></td>
                        ...
                        <div class="modal fade" id="delete-<?php echo $row['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <form action="taxonomist_delete.php" method="POST">
