...
$result = $db->arraybuilder()->paginate('systematics_taxa_types txtp', $page, $cols);
    ...
    <div class="toolbar sticky-top row my-2 p-2">
        <div class="col-12">
            ...
            <div class="float-right">
                <a href="taxon_type.php?task=new&id=0" class="btn btn-primary btn-sm" role="button"><i class="fas fa-plus"></i>New</a>
            </div>
        </div>
    </div>
    <!-- Main -->
                ...
                <table class="table table-striped table-hover table-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="taxon_type.php?task=edit&id=<?php echo $row['id']; ?>"><?php echo htmlspecialchars($row['name']); ?></a></td>
                        ...
                        <div class="modal fade" id="delete-<?php echo $row['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <form action="taxon_type_delete.php" method="POST">
