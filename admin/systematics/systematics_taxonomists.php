        ...
        <div class="col-12">
            <div class="my-3 p-3 bg-white rounded box-shadow">
                ...
                <nav aria-label="<?php echo $page_title?> navigation">
                    ...
                    <ul class="pagination">
                        <!--li class="page-item">
                            <a href="systematics_taxonomists.php<?php echo $http_query; ?>&page=<?php echo $i--; ?>" class="page-link" aria-label="Previous">
                        ...
                        for ($i = 1; $i <= $pagination; $i++)
                        {
                            ...
                            echo '<li class="page-item'.$li_class.'"><a href="systematics_taxonomists.php'.$http_query.'&page='.$i.'" class="page-link">'.$i.'</a></li>';
                        }
                        ?>
                        <!--li class="page-item">
                            <a href="systematics_taxonomists.php<?php echo $http_query; ?>&page=<?php echo $i++; ?>" class="page-link" aria-label="Next">
