        ...
        <div class="toolbar sticky-top row my-2 p-2">
            <div class="col-12">
                ...
                <div class="float-right">
                    ...
                    <a href="taxa_types.php" class="btn btn-outline-danger btn-sm" role="button"><i class="fas fa-times"></i>Cancel</a>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12 col-md-8">
                <div class="my-3 p-3 bg-white rounded box-shadow">
                    <?php $field->text('Name', 'name', $name, 'Enter the Taxon Type name', 'required'); ?>
                </div>
                <div class="my-3 p-3 bg-white rounded box-shadow">
